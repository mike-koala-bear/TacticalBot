...
class SearchThread:
    ...
    def __init__(self, thread_id: int, evaluator, shared_tt: dict,
        ...
        self.current_task: SearchTask | None = None
...
class ParallelSearchEngine:
    ...
    def __init__(self, evaluator, num_threads: int | None = None):
        self.evaluator = evaluator
    ...
    def search(self, board: chess.Board, depth: int, time_limit: float | None = None) -> tuple[chess.Move, int, int]:
